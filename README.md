# nvim-treesitter-queries-smithy

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-smithy/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-smithy/actions/workflows/validate.yml)

Neovim tree-sitter queries for **smithy**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-smithy",
...
- [ ] Changes are scoped to `smithy` — do not include files for other languages
